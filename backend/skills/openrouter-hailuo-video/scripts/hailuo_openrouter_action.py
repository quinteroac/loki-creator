...
from app.models import HailuoVideoGenerationRequest  # noqa: E402
from app.services.hailuo_video import HailuoVideoGenerationService  # noqa: E402
...
def main() -> None:
    ...
    try:
        ...
        raise ValueError(f"MiniMax H3 duration must be an integer, got: {duration_text}") from exc

    request = HailuoVideoGenerationRequest.model_validate({
        "prompt": prompt,
    ...
    response = HailuoVideoGenerationService(repo_root() / ".loki").generate(request)
